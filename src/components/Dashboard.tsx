    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-6 space-y-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">rd910 • Balance: 0.00</p>
              </div>
            </div>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Server Status */}
          <Card className="border-destructive/50 hover-scale fade-in relative overflow-hidden">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-bold text-warning-foreground">0.00</div>
                  </div>
                </div>
                ...
                <TableRow className="hover:bg-muted/30">
                  <TableCell colSpan={6} className="h-32 text-center">
                    <div className="flex flex-col items-center justify-center space-y-2">
                      ...
                      <p className="text-muted-foreground">There is no order history</p>
                      <p className="text-sm text-muted-foreground/70">Your orders will appear here when you start using our services</p>
                    </div>
                  </TableCell>
                </TableRow>
              </TableBody>
